...
export interface IEntityLivingBase extends IEntity {
	 ...
	 */
	applyKnockback(strength: number, source: IEntity): void;
	 ...
	 */
	applyKnockback(strength: number, dirX: number, dirZ: number): void;
	 ...
	 * @param source the source entity to knock back away from.
	 */
	forceKnockback(strength: number, source: IEntity): void;
	 ...
	 * @param dirZ the z component of the knockback direction.
	 */
	forceKnockback(strength: number, dirX: number, dirZ: number): void;
}
