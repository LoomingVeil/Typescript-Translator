...
export interface IItemCustomizable extends IItemStack {
	 ...
	 */
	setTextureAnimated(animated: boolean): void;
	...
	setFirstPersonRotation(x: number, y: number, z: number): void;

	setFirstPersonScale(x: number, y: number, z: number): void;

	setFirstPersonTranslate(x: number, y: number, z: number): void;

	getFirstPersonRotationZ(): number;

	getFirstPersonRotationY(): number;

	getFirstPersonRotationX(): number;

	getFirstPersonScaleZ(): number;

	getFirstPersonScaleY(): number;

	getFirstPersonScaleX(): number;

	getFirstPersonTranslateZ(): number;

	getFirstPersonTranslateY(): number;

	getFirstPersonTranslateX(): number;
	 ...
	 */
	setDyeable(dyeable: boolean): void;
	 ...
	 */
	setUseFirstPersonOverrides(useFirstPersonOverrides: boolean): void;

	usesFirstPersonOverrides(): boolean;

	/**
	 * You can ignore this function. There are likely no cases where it would be useful.
	 */
	getArmorOverlayResource(slot: number): ResourceLocation;

	setItemOverlayTexture(itemOverlayTexture: string): void;

	getItemOverlayTexture(): string;

	setArmorOverlayTexture2(armorOverlayTexture2: string): void;

	getArmorOverlayTexture2(): string;

	setArmorOverlayTexture1(armorOverlayTexture1: string): void;
	 ...
	 * You can ignore this function. There are likely no cases where it would be useful.
	 */
	getArmorResource(slot: number): ResourceLocation;

	/**
	 * Texture for leggings
	 */
	setArmorTexture2(armorTexture2: string): void;
	 ...
	 */
	setArmorTexture1(armorTexture1: string): void;

	getArmorTexture1(): string;

	setArmorColor(armorColor: number): void;

	getArmorColor(): number;
