...
import { IMagic } from "./data/IMagic";
import { IMagicCycle } from "./data/IMagicCycle";
 ...
 */
export interface IMagicHandler extends IObject {
	/**
	 ...
	 */
	getMagic(magicId: number): IMagic;
	 ...
	 */
	getCycle(cycleID: number): IMagicCycle;
